const SHEET_DEFINITIONS = [
  {
    ...
    columns: [
      ...
      { key: 'sumOz', label: 'Σ oz', type: 'number', unit: 'oz', precision: 2, readOnly: true },
      { key: 'unitCost', label: '$ / Unit', type: 'currency', unit: 'USD', precision: 2, readOnly: true },
      ...
      { key: 'baseSpirits', label: 'Spirits', type: 'text', hidden: true },
